...
// Contains the implementation of the BranchAndBoundMaximumDiversitLowestBoundAlgorithm class.

#include "branch_and_bound_maximum_diversity_lowest_bound_algorithm.h"

/**
 * @brief Adds a new branch to the list of open branches, maintaining the order based on the branch bound, lowest first.
 *
 ...
 */
void BranchAndBoundMaximumDiversityLowestBoundAlgorithm::AddNewBranch(std::vector<std::pair<std::vector<bool>, double>>& open_branches, const std::vector<bool>& new_solution, 
